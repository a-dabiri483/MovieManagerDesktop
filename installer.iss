...
OutputBaseFilename=MovieManager_Setup_v3.0.2
...
Source: "{#MyAppSourceDir}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "MPVPlayer\*,*.pdb,*.log,*.txt,*.db,*.db-shm,*.db-wal,obfuscated\*,Mapping.txt"
